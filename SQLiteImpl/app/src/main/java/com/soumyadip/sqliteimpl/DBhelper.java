package com.soumyadip.sqliteimpl;
...
public class DBhelper extends SQLiteOpenHelper {
    ...
    static final String[] columns = new String[]{
            DBhelper.COL_EMP_ID,
            DBhelper.COL_EMP_NAME,
            DBhelper.COL_EMP_ADDRESS,
    ...
    String DATABASE_CREATE = "CREATE TABLE "
            ...
            + COL_EMP_NAME + " TEXT NOT NULL, " + COL_EMP_ADDRESS +
            " TEXT NOT NULL," + COL_EMP_PHONE + " TEXT NOT NULL);";
